...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Bidder.credit'
        db.add_column('auction_bidder', 'credit',
                      self.gf('django.db.models.fields.FloatField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Bidder.credit'
        db.delete_column('auction_bidder', 'credit')
    ...
    models = {
        'auction.bidder': {
            ...
            'credit': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
